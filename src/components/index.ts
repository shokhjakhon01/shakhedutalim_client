...
export { default as Overview } from "./description/description"
...
export { default as InstructorEditCourseCard } from "./instructor-courses-card/instructor-edit-courses-card"
