...
import { InstructorValidation } from "src/validation/instructor.validation"
        ...
        <CardBody p={0}>
          <HStack>
            <Stack px={5}>
              <SectionTitle
                textAlign={"center"}
                titles={t("instructor_page_title", { ns: "instructor" })}
      ...
      <Card>
        <CardBody>
          <Stack textAlign={"center"} w={"500px"} mx={"auto"}>
            <SectionTitle
              titles={t("become_instructor_today", { ns: "instructor" })}
