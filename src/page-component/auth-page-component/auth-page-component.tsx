...
const AuthPageComponent = () => {
  ...
  const renderStateComponent = () => {
    switch (state) {
      case "login":
        return <Login onNavigateStateComponent={navigateStateComponent} />
      case "register":
        return <Register onNavigateStateComponent={navigateStateComponent} />
      case "verification":
        return <Verification />
      case "account-recovery":
        return (
          <AccountRecovery onNavigateStateComponent={navigateStateComponent} />
        )
    }
  }
